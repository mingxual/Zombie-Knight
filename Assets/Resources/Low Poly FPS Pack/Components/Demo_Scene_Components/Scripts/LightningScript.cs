...
public class LightningScript : MonoBehaviour {
	...
	public float lightDurationOne = 0.025f;
	public float lightDurationTwo = 0.025f;
	...
	private IEnumerator LightFlashOne () {
		...
		x = Random.Range (minPos.x, maxPos.y);
		...
		yield return new WaitForSeconds (lightDurationOne);
		//Disable the light
		lightObject.enabled = false;
	...
	private IEnumerator LightFlashTwo () {
		...
		//Wait for set amount of time
		yield return new WaitForSeconds (lightDurationTwo);
		//Disable the light
		lightObject.enabled = false;
